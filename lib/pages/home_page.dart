...
class HomePage extends StatefulWidget {
  final drawerItems = [
    new DrawerItem("Fragment 1", Icons.android),
    new DrawerItem("Fragment 2", Icons.phone_iphone),
    new DrawerItem("Fragment 3", Icons.business)
  ];
        ...
        child: new Column(
          children: <Widget>[
            new UserAccountsDrawerHeader(
                accountName: new Text("Alishen"), accountEmail: null),
